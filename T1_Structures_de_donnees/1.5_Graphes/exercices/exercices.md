...
!!! example "sujet 0 version A - 2024"
...
!!! example "2024 Amérique du Nord J1"
    Exercice 2 du [sujet Amérique du Nord J1 2024](./data/24-NSIJ1AN1.pdf){. target="_blank"}
...
!!! exercice "Codex"
    ...
    - Codex Facile [Cadeaux circulaires](https://codex.forge.apps.education.fr/exercices/permutation_circulaire/)
    - Codex Moyen [Degré de séparation](https://codex.forge.apps.education.fr/en_travaux/degres_separation/)
    - Codex Moyen [La rumeur qui court](https://codex.forge.apps.education.fr/exercices/rumeur/)
    - Codex Moyen [Les amis des amis](https://codex.forge.apps.education.fr/exercices/dico_amis/)