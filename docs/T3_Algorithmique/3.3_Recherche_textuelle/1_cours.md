...
!!! info "Animations"
    ...
    @crédits du cours : Gilles Lassus
    
    Il existe plusieurs sites d'animations des algos sur la recherche textuelle.

    - Sur [https://physalgo.fr](https://physalgo.fr/recherchetextuelle/index.html) par Frédéric Boissac
    - Sur [https://hmalherbe.fr](https://hmalherbe.fr/thalesm/gestclasse/documents/Terminale_NSI/2020-2021/Cours/Recherche_textuelle/Animation_Boyer_Moore/Animation_Boyer_Moore.html) par Hugues Malherbe 
...
Faire évoluer votre fonction `recherche()` en `BMH()` pour qu'elle renvoie à présent la liste de toutes les occurrences de notre motif.
